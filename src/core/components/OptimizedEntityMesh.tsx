...
export interface IOptimizedEntityMeshProps {
 ...
 */
export const OptimizedEntityMesh = forwardRef<Mesh, IOptimizedEntityMeshProps>(
  (
    {
      position = [0, 0, 0],
      rotation = [0, 0, 0, 1],
...
OptimizedEntityMesh.displayName = 'OptimizedEntityMesh';
