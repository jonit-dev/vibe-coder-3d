...
export const LeftSidebarChat: React.FC<ILeftSidebarChatProps> = ({ isExpanded, onToggle }) => {
  ...
  return (
    <div
      ...
      } bg-gradient-to-b from-[#0f0f10] to-[#1a1a1e] border-r border-gray-800/50 flex-shrink-0 flex flex-col h-full relative transition-all duration-300 z-50`}
    >
      {/* Header */}
